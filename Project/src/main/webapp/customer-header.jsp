						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="customer-cart.jsp">Cart</a></li>
									<%List<WishList> list1 = WishListDao.getWishListByCusId(c.getId()); %>
									<li class="nav-item"><a class="nav-link"
										href="wishlist.jsp">WishList&nbsp;&nbsp;(<%out.print(list1.size()); %>)</a></li>
								</ul></li>
										<li class="nav-item submenu dropdown"><a href="#"
								class="nav-link dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false"><%=c.getName() %></a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="seller-profile.jsp">Profile</a></li>
									<li class="nav-item"><a class="nav-link"
										href="seller-change-password.jsp">Change Password</a></li>
									<li class="nav-item"><a class="nav-link"
